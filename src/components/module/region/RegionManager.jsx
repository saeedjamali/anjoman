...
const INITIAL_VISIBLE_COLUMNS = ["provinceName", "provinceCode", "regionCode", "regionName", "actions"];
                                            ...
                                            <form>
                                                <div className="relative mt-2 flex justify-end col-span-1">
                                                    <div className="flex flex-col  w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                                                        ...
                                                        <div className="flex gap-2">
                                                            <Input type="text" label="سطح دسترسی" value={accessType} onChange={() => setAccessType(event.target.value)} />
                                                        </div>
