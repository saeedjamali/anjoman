...
const INITIAL_VISIBLE_COLUMNS = ["phone", "role", "comment", "isBan", "isActive", "actions"];
...
export default function UserAdminManager({ selectedKeys,
    setSelectedKeys }) {
    ...
    const getUsers = async () => {
        ...
        try {
            ...
            const response = await fetch(`/api/manager/users/getusers/${level}/${regionCode}/${provinceCode}`);
    ...
    const updateUsersHandler = async () => {
        ...
        try {
            const response = await fetch(`/api/manager/users/putusers/${user._id}`, {
                method: "PUT",
                body: JSON.stringify({
                    role,
                    isActive,
        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">کل {users.length} کاربران</span>
                                            ...
                                            <div className="relative mt-2 flex justify-end col-span-1">
                                                <div className="flex flex-col  w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                                                    <div className="flex gap-2">
                                                        ...
                                                        <Input type="text" label="نقش" value={role == 'modir' ? "مدیر واحد سازمانی" : "کارشناس"} disabled />
                                                    </div>
                                                    <div className="flex gap-2">
