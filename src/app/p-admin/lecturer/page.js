...
import {
    Autocomplete, AutocompleteItem, ButtonGroup,
    Card, CardBody, CardFooter, CardHeader, Checkbox,
    Chip, Divider, Image, Radio, RadioGroup
}
...
function LecturerPage() {
    ...
    const [notCompletePersonalInformation, setNotCompletePersonalInformation] = useState(true);
    ...
    console.log("currentLecturer region-->", region)
    console.log("currentLecturer province-->", province)
    console.log("currentLecturer degree-->", degree)
    console.log("currentLecturer field-->", field)
    useEffect(() => {
        getRegions(province);
    ...
    useEffect(() => {
        ...
        if (currentLecturer) {
            ...
            setAction(currentLecturer.payment)
                    ...
                    <div className="mb-4 p-4 bg-slate-300 rounded-lg flex items-center justify-between">
                        ...
                        <div className="flex-center gap-8">
                            ...
                            <span
                                ...
                                onClick={() => exportToExcel(lecturerList, 100)}
                            >
                        ...
                        <div className='flex flex-col justify-start mt-4'>
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2  md:gap-4'>
                                        <div className='relative mt-2 flex justify-start col-span-1'>
                                            ...
                                            <Input
                                                ...
                                                value={currentLecturer.name}  ></Input>
                                        </div>
                                        <div className='relative mt-2 flex justify-start col-span-1'>
                                            {/* <span className='text-[10px] absolute bg-slate-200 p-1 rounded-md left-2  w-24  '>نام و نام خانوادگی</span> */}
                                            <Input
                                                ...
                                                label="کد ملی"
                                                labelPlacement={"inside"}
                                                value={currentLecturer.meliCode}  ></Input>
                                        </div>
                                    </div>
                                    <div className='grid grid-cols-1 md:grid-cols-2  md:gap-4'>
                                        <div className='relative mt-2 flex justify-start col-span-1'>
                                            ...
                                            <Input
                                                ...
                                                size='md'
                                                labelPlacement={"inside"}
                                                value={currentLecturer.year} ></Input>
                                        </div>
                                        <div className='relative mt-2 flex justify-start col-span-1'>
                                            {/* <span className='text-[10px] absolute bg-slate-200 p-1 rounded-md left-2  w-24  '>نام و نام خانوادگی</span> */}
                                            <Input
                                                ...
                                                size='md'
                                                labelPlacement={"inside"}
                                                value={currentLecturer.age}  ></Input>
                                        </div>
                                    </div>
                                    <div className='grid grid-cols-1 md:grid-cols-2  md:gap-4'>
                                        <div className=' relative mt-2 flex justify-start col-span-1 '>
                                        ...
                                        {currentLecturer.organ == 1 ?
                                            ...
                                            <div className='relative mt-2 flex justify-start col-span-1'>
                                                ...
                                                <Input
                                                    ...
                                                    label="کد پرسنلی"
                                                    labelPlacement={"inside"}
                                                    value={currentLecturer.prsCode}  ></Input>
                                            </div>
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 mt-2  md:gap-4'>
                                        <div className='relative mt-2 flex justify-start col-span-1'>
                                            ...
                                            <Input
                                                ...
                                                label="استان"
                                                labelPlacement={"inside"}
                                                value={currentLecturer.province?.name}  ></Input>
                                        ...
                                        <div className='relative mt-2 flex justify-start col-span-1'>
                                            <Input
                                                ...
                                                label="منطقه"
                                                labelPlacement={"inside"}
                                                value={currentLecturer.Region?.regionName}  ></Input>
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 md:gap-4'>
                                        <div className='relative mt-2 flex justify-start items-start text-right col-span-1'>
                                            <Input
                                                ...
                                                label="مدرک تحصیلی"
                                                labelPlacement={"inside"}
                                                value={currentLecturer.degree?.name}  ></Input>
                                        ...
                                        <div className='relative mt-2 flex justify-start items-start text-right col-span-1'>
                                            <Input
                                                ...
                                                label="رشته تحصیلی"
                                                labelPlacement={"inside"}
                                                value={currentLecturer.field?.name}  ></Input>

                                        </div>
                                    </div>

                                    <div className='relative mt-4  flex justify-start items-start text-right col-span-2'>
                                        <Checkbox tabIndex={12} isDisabled={true} size='sm' defaultSelected={currentLecturer.isCertificateBefore} radius="md">دارای گواهی نامه مدرسی آموزش خانواده(در سنوات قبل) می باشم.</Checkbox>
                                    </div>
                                    <div className='relative my-2  flex justify-start items-start text-right col-span-2'>
                                        <Checkbox tabIndex={13} isDisabled={true} size='sm' defaultSelected={currentLecturer.isAccepted} radius="md">دارای مدرک دکتری در آموزش و پرورش و یا عضو هیئت علمی در دانشگاه با رتبه استادیار یا دانشیار یا سطح چهار تخصصی حوزه های علمیه می باشم. </Checkbox>
                                    </div>
                            ...
                            <Card className='my-4'>
                                ...
                                <CardBody className='text-[12px] items-start gap-y-4'>
                                    ...
                                    {(currentLecturer.organ == 2 || currentLecturer.organ == 3) &&
                                    ...
                                    }
                                    {
                                        ...
                                        <div className='w-full  relative mt-2 flex justify-between item-center col-span-2'>
                                            ...
                                            <div className="gap-2  ">
                                                {currentLecturer.certificateDoc?.map(
                                                    (image, index) => (
                                                        <div key={index}>
                                                            <ImageLoaderLecturer
                                                                imageUrl={image}
                        ...
                        <div className='flex flex-col justify-start mt-4'>
                            ...
                            <Card className='my-4'>
                                ...
                                <CardBody >
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 md:gap-4'>
                                        <div className=' relative mt-2 flex justify-start col-span-1 '>
                                            <div className="bg-stone-100 rounded-lg w-full items-start justify-start ">
                                                ...
                                                >
                                                    <Radio value="1" size="sm">ثبت نام شده</Radio>
                                                    <Radio value="2" size="sm">قبولی در مصاحبه</Radio>
                                                    <Radio value="3" size="sm">رد در مصاحبه</Radio>
                                        ...
                                        <div className=' relative mt-2 flex justify-start col-span-1 '>
                                            <div className="bg-stone-100 rounded-lg w-full items-start justify-start ">
                                                ...
                                                >
                                                    <Radio value="1" size="sm">رایگان</Radio>
                                                    <Radio value="2" size="sm">تعرفه</Radio>
                                    ...
                                    <div className='relative mt-4  flex justify-start items-start text-right col-span-2'>
                                        <Checkbox tabIndex={12} size='sm' isSelected={isCertificateBefore} onValueChange={setIsCertificateBefore} radius="md">دارای گواهی نامه مدرسی آموزش خانواده(در سنوات قبل) می باشم.</Checkbox>
                                    </div>
                                    <div className='relative my-4  flex justify-start items-start text-right col-span-2'>
                                        <Checkbox tabIndex={13} size='sm' isSelected={isAccepted} onValueChange={setIsAccepted} radius="md">دارای مدرک دکتری در آموزش و پرورش و یا عضو هیئت علمی در دانشگاه با رتبه استادیار یا دانشیار یا سطح چهار تخصصی حوزه های علمیه می باشم. </Checkbox>
                                    </div>
                                ...
                                <CardFooter className='flex items-center justify-between'>
                                    ...
                                    <Button isLoading={isLoading} tabIndex={14} className={`w-48 bg-blue-600  text-white rounded-md text-[12px]`} onClick={() => submitPersonalInfoation(event)}>بروزرسانی اطلاعات </Button>
